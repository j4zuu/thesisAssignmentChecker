...
function seedDatabase() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            db = new sqlite3.Database('./database.sqlite', function (err) {
                if (err) {
                    ...
                    assignments.forEach(function (assignment) {
                        db.run("INSERT INTO assignments (title, description, solution) VALUES (?, ?, ?)", [assignment.title, assignment.description, assignment.solution], function (err) {
                            if (err) {
